...
public class AdminMedicine extends AppCompatActivity {
    ...
    //academic
   // String  urladdress2 = "http://192.168.40.99/myhospital/v1/medicines.php";
    //192.168.40.230
    //home
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdminMedicineListView adminMedicineListView=new AdminMedicineListView(this,medicine,type,volume);
        listView2.setAdapter(adminMedicineListView);
